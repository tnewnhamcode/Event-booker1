...
It is an app for getting fake tickets to fake events that I made up for demonstrative purposes (to show off my code). See requirements.txt for dependencies required to run app.
